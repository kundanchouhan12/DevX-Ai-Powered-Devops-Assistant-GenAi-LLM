...
// Demo history / searches (replace with API call later)
const demoHistory = [
  { repo: "react-dashboard", date: "2026-01-30", status: "completed" },
  { repo: "node-api", date: "2026-01-29", status: "completed" },
  { repo: "ml-model", date: "2026-01-28", status: "failed" },
];
...
export default function Dashboard() {
  ...
  /* Total Searches / History */
  const totalSearches = demoHistory.length;
  ...
  return (
    <Box sx={pageStyle}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <StatCard icon={<CodeIcon />} label="Lines of Code" value={data.lines} />
        <StatCard icon={<SmartToyIcon />} label="Repo" value="AI Analyzed" />
        <StatCard icon={<SmartToyIcon />} label="Total Searches" value={totalSearches} />
      </Grid>
